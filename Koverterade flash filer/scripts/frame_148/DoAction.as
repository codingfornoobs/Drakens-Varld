function runRight()
{
   algen_ghost.tween("_x",500,2,"linear",0,runLeft);
   algen_ghost._xscale = algen_curScale;
}
function runLeft()
{
   algen_ghost.tween("_x",100,2,"linear",0,runRight);
   algen_ghost._xscale = - algen_curScale;
}
function runOut()
{
   algen_ghost.stopTween("_x");
   algen_ghost.tween("_x",800,2,"linear",0);
   algen_ghost._xscale = algen_curScale;
}
map._visible = false;
...
MovieClip.prototype.stopTween = function(props)
{
   switch(typeof props)
   {
      ...
      case "object":
         ...
         break;
      default:
         for(_loc4_ in this.$_tweenPropList)
         {
            this.__tweenController_ADVhelper__.removeMovieClip();
            this.__tweenController__.removeMovieClip();
         }
...
_global.findTweenValue = function(_propStart, _propDest, _timeStart, _timeNow, _timeDest, _animType, _extra1, _extra2)
{
   ...
   switch(_animType.toLowerCase())
   {
      ...
      case "easeinquad":
         return _loc2_ * (_loc1_ /= _loc4_) * _loc1_ + _loc3_;
      case "easeoutquad":
         return (- _loc2_) * (_loc1_ /= _loc4_) * (_loc1_ - 2) + _loc3_;
      case "easeinoutquad":
         if((_loc1_ /= _loc4_ / 2) < 1)
         {
         ...
         break;
      case "easeincubic":
         return _loc2_ * (_loc1_ /= _loc4_) * _loc1_ * _loc1_ + _loc3_;
      case "easeoutcubic":
      ...
      case "easeinoutcubic":
         ...
         return _loc2_ / 2 * ((_loc1_ -= 2) * _loc1_ * _loc1_ + 2) + _loc3_;
         break;
      case "easeinquart":
         return _loc2_ * (_loc1_ /= _loc4_) * _loc1_ * _loc1_ * _loc1_ + _loc3_;
      case "easeoutquart":
      ...
      case "easeinoutquart":
         ...
         return (- _loc2_) / 2 * ((_loc1_ -= 2) * _loc1_ * _loc1_ * _loc1_ - 2) + _loc3_;
         break;
      case "easeinquint":
         return _loc2_ * (_loc1_ /= _loc4_) * _loc1_ * _loc1_ * _loc1_ * _loc1_ + _loc3_;
      case "easeoutquint":
      ...
      case "easeinoutquint":
         ...
         return _loc2_ / 2 * ((_loc1_ -= 2) * _loc1_ * _loc1_ * _loc1_ * _loc1_ + 2) + _loc3_;
         break;
      case "easeinsine":
      ...
      case "easeinoutexpo":
         ...
         break;
      case "easeincirc":
         return (- _loc2_) * (Math.sqrt(1 - (_loc1_ /= _loc4_) * _loc1_) - 1) + _loc3_;
      case "easeoutcirc":
      ...
      case "easeinoutcirc":
         ...
         return _loc2_ / 2 * (Math.sqrt(1 - (_loc1_ -= 2) * _loc1_) + 1) + _loc3_;
         break;
      case "easeinelastic":
         if(_loc1_ == 0)
         {
         ...
         return - _loc7_ * Math.pow(2,10 * (_loc1_ -= 1)) * Math.sin((_loc1_ * _loc4_ - _loc5_) * 6.283185307179586 / _loc6_) + _loc3_;
         break;
      case "easeoutelastic":
         if(_loc1_ == 0)
         {
      ...
      case "easeinoutelastic":
         ...
         if(_loc1_ < 1)
         {
            return -0.5 * (_loc7_ * Math.pow(2,10 * (_loc1_ -= 1)) * Math.sin((_loc1_ * _loc4_ - _loc5_) * 6.283185307179586 / _loc6_)) + _loc3_;
         }
         return _loc7_ * Math.pow(2,-10 * (_loc1_ -= 1)) * Math.sin((_loc1_ * _loc4_ - _loc5_) * 6.283185307179586 / _loc6_) * 0.5 + _loc2_ + _loc3_;
         break;
      case "easeinback":
         if(_loc5_ == undefined)
         {
         ...
         return _loc2_ * (_loc1_ /= _loc4_) * _loc1_ * ((_loc5_ + 1) * _loc1_ - _loc5_) + _loc3_;
      case "easeoutback":
         if(_loc5_ == undefined)
         {
            _loc5_ = 1.70158;
      ...
      case "easeinoutback":
         ...
         if((_loc1_ /= _loc4_ / 2) < 1)
         {
            return _loc2_ / 2 * (_loc1_ * _loc1_ * (((_loc5_ *= 1.525) + 1) * _loc1_ - _loc5_)) + _loc3_;
         }
         return _loc2_ / 2 * ((_loc1_ -= 2) * _loc1_ * (((_loc5_ *= 1.525) + 1) * _loc1_ + _loc5_) + 2) + _loc3_;
         break;
      case "easeinbounce":
         return _loc2_ - findTweenValue(0,_loc2_,0,_loc4_ - _loc1_,_loc4_,"easeOutBounce") + _loc3_;
      case "easeoutbounce":
         if((_loc1_ /= _loc4_) < 0.36363636363636365)
         {
...
delete mp;
algen_curScale = algen_ghost._xscale;
if(turnLandGood)
{
   ...
   tree2.gotoAndStop(2);
   tree3.gotoAndStop(2);
   shadow1._visible = false;
   shadow2._visible = false;
   shadow3._visible = false;
   hus.gotoAndStop(2);
   algen_ghost._visible = false;
}
else
{
   if(random(2) == 0)
   {
      ...
      streamSound("algen_ghosthouse.mp3","algen_ghost");
   }
   else
   {
      algen_ghost._visible = false;
   }
   stream_s.onSoundComplete = function()
   {
      runOut();
   };
   runRight();
}
if(!been_played_ghosthouse or taken_pusselbit6)
{
   pusselbit6._x = 1000;
}
safeX = 280;
